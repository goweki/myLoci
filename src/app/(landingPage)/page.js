  ...
  return (
    <>
      ...
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-gray-light0 via-gray-light0 dark:from-gray-dark0 dark:via-gray-dark0 lg:static lg:h-auto lg:w-auto lg:bg-none">
          <a
